app.controller("BillCtrl", function($scope){
    ...
    $scope.profil=function(){
        var truc="";
        if ($scope.imc()<16.5){truc="Dénutrition ou famine";$scope.myVar="class-red"}
        else if($scope.imc()<=18.5){truc="Maigreur";$scope.myVar="class-orange-plus"} 
        ...
        else if($scope.imc()<=35){truc="Obésité modérée";$scope.myVar="class-orange-plus"}
        else if($scope.imc()<=40){truc="Obésité sévère";$scope.myVar="class-red"}
        else {truc="Obésité morbide ou massive";$scope.myVar="class-red"}
        return truc;
    };
